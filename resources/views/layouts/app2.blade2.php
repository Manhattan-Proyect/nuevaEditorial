...
<head>
   ...
   <style type="text/css">
    html, body{display: block;height: 100%; margin-bottom: 0; padding-bottom: 0;}
    .color-letra{           
...
">
    @yield('content')
        ...
        <!--  INICIO FOOTER!!!-->
            ...
            <footer class="footer-distributed color-fondo" style="position: relative; bottom: 0; clear: both;">
