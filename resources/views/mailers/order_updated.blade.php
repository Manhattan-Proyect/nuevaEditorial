                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <strong>Hola!!:</strong> Se actualizo la información de tu pedido. Aqui los datos actualizados.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                          ...
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              <tr>
                                                                  ...
                                                                  <th scope="col" valign="top" width="25%" class="dataTableHeading" mc:edit="data_table_heading01">
																	...
																	<tr mc:repeatable>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00">Numero de guia</td>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{$order->guide_number}}</td>
																	</tr>

																	<tr mc:repeatable>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00">Estado</td>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{$order->guide_status}}</td>
																	</tr>

																	<tr mc:repeatable>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00">Direccion</td>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{$order->address()}}</td>
																	</tr>

																	<tr mc:repeatable>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00">Nombre del receptor</td>
																	...
																	<tr>
																		<td valign="top" class="bodyContent">
																			<div mc:edit="std_content01">
																				Si algun dato no coincide comunicacion con <a href="mailto:info@manhattan.com">info@manhattan.com</a>
																			</div>
																		</td>
																	</tr>
                                                          </table>
                                                    ...
                                                    <tr>
                                                    	<td align="center" valign="top" style="padding-top:0;">
                                                        	<table border="0" cellpadding="15" cellspacing="0" class="templateButton">
                                                            	<tr>
                                                                	<td valign="middle" class="templateButton Content">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartId())}}" target="_blank">Ver más información del pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2016 Manhattan, All rights reserved.</em>
