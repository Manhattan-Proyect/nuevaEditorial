                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <h1 class="h1">Comprobante de pago en Manhattan</h1>

                                                                <strong>Hola!!:</strong> Tu compra se realizo con éxito. Te enviamos el detalle de la misma.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                          ...
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              <tr>
                                                                  ...
                                                                  <th scope="col" valign="top" width="25%" class="dataTableHeading" mc:edit="data_table_heading01">
																	...
																	<tr mc:repeatable>
																		<td><img src="{{url("/products/image/$product->id.$product->extension")}}" class="product-avatar"></td>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00">{{$product->descripcion}}</td>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{$product->precio_final}}</td>
																	</tr>
																	@endforeach
																	<tr mc:repeatable>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content02">Total</td>
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content03">{{$order->total}}</td>
																	</tr>
                                                          </table>
                                                        </td>
                                                    </tr>
